...
def update_data(cursor, symbol, data):
    try:
        ...
        values = (
            ...
            data.get("fg_graphkey_normal_p_affo_ratio"),
            data.get("fg_graphkey_normal_p_ocf_ratio"),
            data.get("fg_graphkey_normal_p_ffo_ratio"),
...
def process_json_files(folder_path):
    ...
    field_mapping = {
        ...
        "fg_graphkey_normal_p_affo_ratio" : "Normal P/AFFO Ratio",
        "fg_graphkey_normal_p_ocf_ratio" : "Normal P/OCF Ratio",
        "fg_graphkey_normal_p_ffo_ratio" : "Normal P/FFO Ratio",
